...
public function getKardexBuscar($id,$inicio,$fin){
    ...
    $this->db->select("p.*,pr.codigo as codigo,pr.id_presentacion_producto as pre_producto,m.nombre as id_marca, pre.nombre as id_presentacion,s.stock_actual as existencias");
