...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-01-2020 a las 03:29:29
...
INSERT INTO `ajustes` (`id`, `nombre`, `direccion`, `registro`, `giro`, `logo`, `telefono`, `correo`, `codigo`) VALUES
(1, 'Bazar Zulma', 'San Miguel', '138513-0', 'venta de ropa', 'photo4906976604010424386.jpg', '6109-9440', 'holak@hace.com', 1);
...
(1, 0, 1, 'Konny', 'hugoale_ab2@hotmail.com', 1, 'd033e22ae348aeb5660fc2140aec35850c4da997');
...
--
ALTER TABLE `presentaciones_producto`
  MODIFY `id_presentacion_producto` int(11) NOT NULL AUTO_INCREMENT;
--
