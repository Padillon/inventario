...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-04-2019 a las 06:06:36
...
(1, 2, 2, 14.25, 0, 28.5, 1),
(2, 2, 2, 14.25, 0, 28.5, 3),
(3, 1, 1, 13.45, 0, 13.45, 3);
...
(1, 1, 1, '2019-04-27', 28.5, 1, 1),
(3, 1, 1, '2019-04-27', 41.95, 1, 1);
...
INSERT INTO `productos` (`id_producto`, `id_categoria`, `id_marca`, `codigo`, `id_stock`, `nombre`, `descripcion`, `precio_compra`, `precio_venta`, `imagen`, `inventariable`, `id_presentacion`, `perecedero`, `estado`) VALUES
(1, 2, 1, '123', 1, 'mozzarella', 'queso mozzarella 5 lb', 13.45, 0, '', 0, 1, 1, 1),
(2, 2, 2, '1234', 2, 'harina fuerza', 'harina 45 libras', 14.25, 0, '', 0, 1, 1, 1);
