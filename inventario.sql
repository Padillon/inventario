...
-- Tiempo de generación: 04-01-2020 a las 17:55:49
...
--
-- Base de datos: `id10335939_inventario`
--
...
(20, 7, 43, 3.5, 24.5, 19, 29, 1),
(21, 7, 46, 0.75, 5.25, 20, 33, 1),
(22, 10, 51, 29, 290, 21, 35, 1),
(23, 10, 51, 2.5, 25, 21, 34, 1),
(24, 100, 51, 2.5, 250, 22, 34, 1);
...
(19, 1, 1, '2019-12-30', 24.5, 1, 1),
(20, 1, 1, '2019-12-31', 5.25, 2, 1),
(21, 1, 1, '2019-12-31', 315, 1, 1),
(22, 1, 1, '2020-01-02', 250, 1, 1);
...
(45, 1, '2019-12-30', 'Compra de producto.', 43, 7, 3.5, 24.5, 19, 0, 29, 1),
(46, 1, '2019-12-31', 'Compra de producto.', 46, 7, 0.75, 5.25, 20, 0, 33, 1),
(47, 1, '2019-12-31', 'Compra de producto.', 51, 10, 29, 290, 21, 0, 35, 1),
(48, 1, '2019-12-31', 'Compra de producto.', 51, 10, 2.5, 25, 21, 0, 34, 1),
(49, 7, '2019-12-31', 'salida', 51, 1, 3.5, 3.5, 0, 0, 34, 1),
(50, 1, '2020-01-02', 'Compra de producto.', 51, 100, 2.5, 250, 22, 0, 34, 1);
...
(4, 43, 19, 7, '2019-12-30', '2020-01-16', 1);
...
(30, 4, 45, 1, 1.25, 1.66, '000500060001', 1, 1),
(31, 6, 45, 12, 15, 20, '000500060001', 0, 1),
(32, 4, 46, 1, 1, 1, '1233', 0, 1),
(33, 6, 46, 12, 0.75, 13, '1234', 1, 1),
(34, 4, 51, 100, 2.5, 3.75, '000100070001', 1, 1),
(35, 7, 51, 10, 29, 35, '000100070001', 0, 1);
...
(44, 4, 60, 'S10', 'Bonito', NULL, 0, 1, 4),
(45, 6, 61, 'Blusa tipo polo', 'Algodón', NULL, 0, 1, 5),
(46, 1, 62, 'ejemplo 9', 'ejemplo', 'calabaza.png', 0, 1, 1),
(51, 7, 67, 'papel bond', 'blanco', NULL, 0, 1, 1);
...
--
ALTER TABLE `detalle_entrada`
  MODIFY `id_detalle_entrada` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `kardex`
  MODIFY `id_kardex` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `presentaciones_producto`
  MODIFY `id_presentacion_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `stock`
  MODIFY `id_stock` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
